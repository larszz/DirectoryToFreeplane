...
class MindmapHelper:
    ...
    def add_necessary_attributes_to_node(element: etree._Element):
        ElementHelper.add_attribute_to_element(element, names.Attributes.position, values.Values.MindmapValues.node_position_default)
        ElementHelper.add_attribute_to_element(element, names.Attributes.created, str(TimeHelper.get_current_unix_time_in_ms()))
        ElementHelper.add_attribute_to_element(element, names.Attributes.modified, str(TimeHelper.get_current_unix_time_in_ms()))
